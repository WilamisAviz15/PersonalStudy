...
export class OccurrenceUpdateDto {
  @IsNotEmpty({ message: 'O campo de ID da ocorrência é obrigátorio.' })
  @IsInt({ message: 'O campo de ID da ocorrência precisa ser um inteiro.' })
  id: number;
