...
export class CreateTableMenus1681241275459 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createForeignKey(this.menusTable, this.menuGroupIdForeignKey);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropForeignKey(this.menusTable, this.menuGroupIdForeignKey);
