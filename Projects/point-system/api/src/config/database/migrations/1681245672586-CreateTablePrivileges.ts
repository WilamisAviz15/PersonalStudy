...
export class CreateTablePrivileges1681245672586 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createForeignKeys(this.privilegesTable, [this.roleIdForeignKey, this.actionMenuIdForeignKey]);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropForeignKeys(this.privilegesTable, [this.actionMenuIdForeignKey, this.roleIdForeignKey]);
