...
export class CreateTableActionsMenus1681245084286 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createForeignKeys(this.actionsMenusTable, [this.actionIdForeignKey, this.menuIdForeignKey]);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropForeignKeys(this.actionsMenusTable, [this.menuIdForeignKey, this.actionIdForeignKey]);
