...
export class PrivilegesSeed implements Seeder {
  public async run(dataSource: DataSource): Promise<any> {
    ...
    await repository.insert([
      ...
      { roleId: 1, actionMenuId: 71 },
      { roleId: 1, actionMenuId: 72 },
      { roleId: 1, actionMenuId: 73 },
      { roleId: 1, actionMenuId: 74 },
      { roleId: 1, actionMenuId: 75 },
      { roleId: 1, actionMenuId: 76 },
      { roleId: 1, actionMenuId: 77 },
      { roleId: 1, actionMenuId: 78 },
      { roleId: 1, actionMenuId: 79 },
      { roleId: 1, actionMenuId: 80 },
      { roleId: 1, actionMenuId: 81 },
      { roleId: 1, actionMenuId: 82 },
      { roleId: 1, actionMenuId: 83 },
      { roleId: 1, actionMenuId: 84 },
      { roleId: 1, actionMenuId: 85 },
    ]);
  }
}
